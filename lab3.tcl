...
$ns duplex-link $n0 $n2 100Mb 30ms DropTail
$ns duplex-link $n1 $n2 100Mb 30ms DropTail
$ns duplex-link $n2 $n3 100Mb 30ms DropTail
$ns duplex-link $n2 $n4 100Mb 30ms DropTail
$ns duplex-link $n4 $n5 100Mb 30ms DropTail
...
$telnet1 set packetSize_ 10Mb
$telnet1 set interval_ 0.1

$ftp0 set packetSize_ 10Mb
